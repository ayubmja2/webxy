                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('cookbook.index')" :active="route().current('cookbook.index')">
                                    Cook Book
                                </NavLink>
                            </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('profile.show', $page.props.auth.user.name)"> Profile </DropdownLink>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('profile.show', $page.props.auth.user.name)"> Profile </ResponsiveNavLink>
